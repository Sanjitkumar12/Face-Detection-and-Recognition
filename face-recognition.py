...
while True:
    ...
    for(x,y,w,h) in faces:
        ...
        if Id == 5:
            Id = "Raja {0:.2f}%".format(round(100 - confidence, 2))
            # Put text describe who is in the picture
        elif Id == 6:
            Id = "Deepak {0:.2f}%".format(round(100 - confidence, 2))
            # Put text describe who is in the picture
        elif Id == 7:
            Id = "Sanjit {0:.2f}%".format(round(100 - confidence, 2))
            # Put text describe who is in the picture
        elif Id == 8:
            Id = "Ronuj {0:.2f}%".format(round(100 - confidence, 2))
            # Put text describe who is in the picture
        elif Id == 9:
            Id = "Sunbrajis {0:.2f}%".format(round(100 - confidence, 2))
            # Put text describe who is in the picture
        else:
            pass
